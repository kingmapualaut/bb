...
apt update
apt upgrade -y
apt install openvpn nginx stunnel4 privoxy squid3 dropbear vnstat build-essential fail2ban zip -y
...
wget "https://github.com/johndesu090/AutoScriptDS/raw/master/Files/Plugins/keys.zip"
unzip keys.zip
